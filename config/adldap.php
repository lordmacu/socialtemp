            ...
            */
            ...
            'connection_settings' => [
                ...
                */
                ...
                'domain_controllers' => explode(' ', '172.16.15.104 172.16.15.105'),
                ...
                */
                ...
                //'base_dn' => 'OU=-Users,DC=romikin,DC=com,DC=ar',
                'base_dn' => 'OU=-Users,DC=argentina,DC=chemogroup,DC=local',
                ...
                */
                ...
                'admin_username' => env('ADLDAP_ADMIN_USERNAME', 'cgramirez@argentina.chemogroup.local'),
                'admin_password' => env('ADLDAP_ADMIN_PASSWORD', '12345678'),
