								...
								<div id="accordion-1" role="tablist" aria-multiselectable="true" class="day-event" date-month="12" date-day="2">
									<div class="card">
										...
										<div class="more"><svg class="olymp-three-dots-icon"><use xlink:href="{{asset('img/icons.svg')}}#olymp-three-dots-icon"></use></svg>
											...
											<h5 class="mb-0 title">
												<a data-toggle="collapse" data-parent="#accordion" href="#collapseOne-1" aria-expanded="true" aria-controls="collapseOne">
													...
													<span class="event-status-icon"  data-toggle="modal" data-target="#public-event" data-toggle="tooltip" data-placement="top" title="" data-original-title="UNCOMPLETED">
														<svg class="olymp-calendar-icon"><use xlink:href="{{asset('img/icons.svg')}}#olymp-calendar-icon"></use></svg>
													</span>
												</a>
											</h5>
										</div>
										...
										<div id="collapseOne-1" class="collapse show" role="tabpanel" aria-labelledby="headingOne">
											...
											<div class="place inline-items">
												<svg class="olymp-add-a-place-icon"><use xlink:href="{{asset('img/icons.svg')}}#olymp-add-a-place-icon"></use></svg>
										...
										<div class="more"><svg class="olymp-three-dots-icon"><use xlink:href="{{asset('img/icons.svg')}}#olymp-three-dots-icon"></use></svg>
											...
											<h5 class="mb-0 title">
												<a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo-1" aria-expanded="true" aria-controls="collapseTwo-1">
													...
													<span class="event-status-icon completed" data-toggle="tooltip" data-placement="top" title="" data-original-title="COMPLETED">
														<svg class="olymp-checked-calendar-icon"><use xlink:href="{{asset('img/icons.svg')}}#olymp-checked-calendar-icon"></use></svg>
													</span>
												</a>
											</h5>
										</div>
									...
									<div class="card">
										...
										<div class="more"><svg class="olymp-three-dots-icon"><use xlink:href="{{asset('img/icons.svg')}}#olymp-three-dots-icon"></use></svg>
											...
											<h5 class="mb-0 title">
												<a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseThree-1" aria-expanded="false" aria-controls="collapseThree">
													Take Querty to the Veterinarian
													<span class="event-status-icon" data-toggle="modal" data-target="#private-event" data-toggle="tooltip" data-placement="top" title="" data-original-title="UNCOMPLETED">
														<svg class="olymp-calendar-icon"><use xlink:href="{{asset('img/icons.svg')}}#olymp-calendar-icon"></use></svg>
													</span>
												</a>
											</h5>
								...
								<ul class="nav nav-tabs fc-right" role="tablist">
									<li class="nav-item">
										<a class="nav-link active" data-toggle="tab" href="#month" role="tab">
											<svg class="olymp-month-calendar-icon"><use xlink:href="{{asset('img/icons.svg')}}#olymp-month-calendar-icon"></use></svg>
										</a>
									</li>

									<li class="nav-item">
										<a class="nav-link" data-toggle="tab" href="#week" role="tab">
											<svg class="olymp-week-calendar-icon"><use xlink:href="{{asset('img/icons.svg')}}#olymp-week-calendar-icon"></use></svg>
										</a>
									</li>

									<li class="nav-item">
										<a class="nav-link" data-toggle="tab" href="#day" role="tab">
											<svg class="olymp-day-calendar-icon"><use xlink:href="{{asset('img/icons.svg')}}#olymp-day-calendar-icon"></use></svg>
										</a>
									</li>
								</ul>
								...
								<div class="tab-content">
									...
									<div class="tab-pane" id="week" role="tabpanel">
										...
										<div class="no-past-events">
											...
											<a href="#" class="h6" data-toggle="modal" data-target="#create-event">Create an Event</a>
										</div>
									</div>
														...
														<div class="card-header" role="tab" id="headingOne">
															...
															<h5 class="mb-0 title">
																<a data-toggle="collapse" data-parent="#accordion" href="#" aria-expanded="true">
																	Chris Greyson’s Bday
																	<span class="event-status-icon checked" data-toggle="tooltip" data-placement="top" title="" data-original-title="CHECKED">
																		<svg class="olymp-checked-calendar-icon"><use xlink:href="{{asset('img/icons.svg')}}#olymp-checked-calendar-icon"></use></svg>
																	</span>
																</a>
															</h5>
														...
														<div class="card-header" role="tab" id="headingThree">
															...
															<h5 class="mb-0 title">
																<a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
																	Make Dinner Plans with Jennifer
																	<svg class="olymp-dropdown-arrow-icon"><use xlink:href="{{asset('img/icons.svg')}}#olymp-dropdown-arrow-icon"></use></svg>
																	<span class="event-status-icon completed" data-toggle="modal" data-target="#public-event" data-toggle="tooltip" data-placement="top" title="" data-original-title="UNCOMPLETED">
																		<svg class="olymp-checked-calendar-icon"><use xlink:href="{{asset('img/icons.svg')}}#olymp-checked-calendar-icon"></use></svg>
																	</span>
																</a>
															</h5>
							...
							<tr class="event-item">
								...
								<td class="upcoming">
									<div class="date-event inline-items align-left">
										<svg class="olymp-small-calendar-icon"><use xlink:href="{{asset('img/icons.svg')}}#olymp-small-calendar-icon"></use></svg>
	...
	<div class="modal-dialog ui-block window-popup event-private-public public-event">
		...
		<article class="hentry post has-post-thumbnail thumb-full-width private-event">
			...
			<div class="post-thumb">
				<img src="img/event-public.jpg" alt="photo">
			</div>
			...
			<div class="row">
				<div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
					<div class="post__author author vcard inline-items">
						...
						<div class="author-date">
							<a class="h6 post__author-name fn" href="#">Green Goo Rock</a> created the <a href="#">Event</a>
			...
			<div class="post-additional-info inline-items">
				...
				<a href="#" class="post-add-icon inline-items">
					<svg class="olymp-heart-icon"><use xlink:href="{{asset('img/icons.svg')}}#olymp-heart-icon"></use></svg>
					<span>8</span>
				</a>
				...
				<div class="comments-shared">
					<a href="#" class="post-add-icon inline-items">
						<svg class="olymp-speech-balloon-icon"><use xlink:href="{{asset('img/icons.svg')}}#olymp-speech-balloon-icon"></use></svg>
			...
			<div class="control-block-button post-control-button">
				...
				<a href="#" class="btn btn-control">
					<svg class="olymp-like-post-icon"><use xlink:href="{{asset('img/icons.svg')}}#olymp-like-post-icon"></use></svg>
				</a>

				<a href="#" class="btn btn-control">
					<svg class="olymp-comments-post-icon"><use xlink:href="{{asset('img/icons.svg')}}#olymp-comments-post-icon"></use></svg>
				</a>

				<a href="#" class="btn btn-control">
					<svg class="olymp-share-icon"><use xlink:href="{{asset('img/icons.svg')}}#olymp-share-icon"></use></svg>
				</a>
			...
			<div class="form-group with-icon-right">
				...
				<div class="add-options-message">
					<a href="#" class="options-message">
						<svg class="olymp-camera-icon"><use xlink:href="{{asset('img/icons.svg')}}#olymp-camera-icon"></use></svg>
					</a>
				</div>
	...
	<div class="ui-block-content">
			...
			<div class="form-group date-time-picker label-floating">
				...
				<span class="input-group-addon">
					<svg class="olymp-calendar-icon icon"><use xlink:href="{{asset('img/icons.svg')}}#olymp-calendar-icon"></use></svg>
				</span>
			</div>
			...
			<form class="form-group label-floating is-select">
				...
				<select class="selectpicker form-control style-2 show-tick" multiple data-live-search="true" size="auto">
